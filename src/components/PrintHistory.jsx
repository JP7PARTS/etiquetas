...
const styles = {
  ...
  summary: { padding: '12px 14px', background: 'var(--color-muted)', border: '1px solid var(--border)', borderRadius: '8px', marginBottom: '14px' },
  ...
  zebra: { background: 'var(--color-muted)' },
  ...
  custom: { display: 'inline-block', marginBottom: '4px', fontSize: '10.5px', fontWeight: 700, color: 'var(--color-warning-fg)', background: 'var(--color-warning-bg)', padding: '2px 8px', borderRadius: '10px', whiteSpace: 'nowrap' },
